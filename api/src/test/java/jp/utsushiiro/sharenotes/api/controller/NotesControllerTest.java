...
import jp.utsushiiro.sharenotes.api.ShareNotesAPIServer;
...
@SpringBootTest(classes = ShareNotesAPIServer.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@ActiveProfiles("test")
